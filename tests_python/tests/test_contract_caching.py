...
class TestContractCaching:
    ...
    # This test checks that the gas limit when running the same contract twice
    # in a transaction is less than the gas limit when running two distinct
    # (but otherwise identical) contracts.
    ...
    # This test checks that the gas limit when running the same contract twice
    # in a transaction non-consequitively is less than the gas limit when
    # making the same transaction using two distinct (but otherwise identical)
    # contracts in place of the repeated contract.
